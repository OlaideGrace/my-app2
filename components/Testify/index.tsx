            ...
            <div className="mt-3">
                ...
                <div className="row mb-5">
                    <div className="col-12 col-md-6 mb-4 mb-md-0">
                        <p> <b> INTERNATIONAL LANGUAGES: </b> <br /> FRENCH,CERMAN,SPANISH AND CHINESE <br /> -For business,education or leisure purposes</p>
                    </div>
                    <div className="col-12 col-md-6">
                        <p> <b> INDICENOUS LANCUAGES: YORUBA,ICBO <br /> AND HAUSA </b> <br /> Learning indigenous language helps the learner <br /> to connect to n s or her root</p>
                    </div>
                </div>
                <div className="mb-4">
